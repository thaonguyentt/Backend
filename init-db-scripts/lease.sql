...
values (1, 1, 2, 1, 'ORDERED_PAYMENT_PENDING', '2024/04/20', '2024/06/01', null, null,
        ...
        'Đường Kim Giang, Phường Kim Giang, Quận Thanh Xuân, Hà Nội', 117600.00, 0.00, 224100.00, 1, null, null, null,
        null),
       (2, 2, 1, 2, 'ORDERED_PAYMENT_PENDING', '2024/05/01', '2024/06/01', null, null,
        'Đường Kim Giang, Phường Kim Giang, Quận Thanh Xuân, Hà Nội',
        '123 Nguyễn Trọng Tuyển, phường 12, quận Bình Thạnh', 9000.00, 0, 414800.00, 1, null, null, null,
        null),
       (3, 2, 1, 3, 'CANCELED', '2024/03/01', '2024/04/01', null, null,
        'Đường Kim Giang, Phường Kim Giang, Quận Thanh Xuân, Hà Nội',
        '123 Nguyễn Trọng Tuyển, phường 12, quận Bình Thạnh', 84000.00, 0, 46000.00, 1, null, null, null,
            null),
       ...
       (5, 2, 3, 4, 'DELIVERED', '2024/05/01', '2024/06/01', '2024/05/01', null,
        'Đường Kim Giang, Phường Kim Giang, Quận Thanh Xuân, Hà Nội',
        'phố minh khai, Phường Minh Khai, Quận Hai Bà Trưng, Hà Nội', 42000.00, 0, 383700.00, 1, null, null, null,
        null),
       (6, 2, 4, 5, 'RETURNED', '2024/05/01', '2024/06/01', '2024/05/01', '2024/06/01',
        'Đường Kim Giang, Phường Kim Giang, Quận Thanh Xuân, Hà Nội',
        'Đường Kim Giang, Phường Kim Giang, Quận Thanh Xuân, Hà Nội', 78000.00, 0, 376600.00, 1, null, null, null,
        null),
       (7, 2, 5, 6, 'LATE_RETURN', '2024/03/01', '2024/04/01', '2024/03/01', '2024/04/10',
        'Đường Kim Giang, Phường Kim Giang, Quận Thanh Xuân, Hà Nội',
        'Đường Yên Hòa, Phường Yên Hoà, Quận Cầu Giấy, Hà Nội', 48000.00, 15000.00, 105700.00, 1, null, null, null,
        null),
       (8, 2, 6, 7, 'DEPOSIT_RETURNED', '2024/03/01', '2024/04/01', '2024/03/01', '2024/04/01',
        'Đường Kim Giang, Phường Kim Giang, Quận Thanh Xuân, Hà Nội',
        'Đường Tây Sơn, Phường Trung Liệt, Quận Đống Đa, Hà Nội', 36000.00, 0, 120300.00, 1, null, null, null,
        null),
       (9, 2, 7, 8, 'PAID_OWNER', '2024/03/01', '2024/04/01', '2024/03/01', '2024/04/01',
        'Đường Kim Giang, Phường Kim Giang, Quận Thanh Xuân, Hà Nội',
        'Đường Lò Đúc, Phường Đống Mác, Quận Hai Bà Trưng, Hà Nội', 60000.00, 0, 76500.00, 1, null, null, null,
        null),
       (10, 2, 8, 9, 'RETURNING', '2024/03/01', '2024/04/01', '2024/03/01', '2024/04/01',
        'Đường Kim Giang, Phường Kim Giang, Quận Thanh Xuân, Hà Nội',
        'Đường Xuân La, Phường Xuân La, Quận Tây Hồ, Hà Nội', 42000.00, 0, 194200.00, 1, null, null, null,
        null),
       (11, 1, 2, 1, 'RETURNED', '2024/02/01', '2024/03/01', '2024/02/05', '2024/03/01',
        '123 Nguyễn Trọng Tuyển, phường 12, quận Bình Thạnh',
        'Đường Kim Giang, Phường Kim Giang, Quận Thanh Xuân, Hà Nội', 8400.00, 0, 224100, 1, null, null, null,
        null);
