...
public class VoucherShop {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "voucher_shop_id_gen")
    @SequenceGenerator(name = "voucher_shop_id_gen", sequenceName = "voucher_shop_id_seq", allocationSize = 1)
